...
make_task("9:49", say, ["Start. Learn English", True], READ_INTERVAL, END_TEXT)
...
make_task("16:15", say, ["Start. Read Algorithms. Patterns. O.O.P.", True], READ_INTERVAL, END_TEXT)
...
# May eat
#make_task("19:10", say, ["Begin. "], , END_TEXT)
