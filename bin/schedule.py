...
def make_schedule_one():
    ...
    make_task("11:02", ["Start. training set Core 1"], TRAIN_INTERVAL)

    make_task("11:33", ["Begin. geometry task"], TASK_GEO_INTERVAL)
    make_task("11:43", ["Start. Affirmate. write some new."], 0, False)
    ...
    make_task("16:39", ["Start. Learn English"], READ_INTERVAL)
