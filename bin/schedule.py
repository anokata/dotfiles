...
def make_schedule_one():
    ...
    make_task("7:22", ["Start. Speak exercise with english vowels"], 0, False)
    ...
    make_task("11:00", ["Begin. training set 2"], TRAIN_INTERVAL, False) # 10:55
    make_task("11:04", ["Start. training set Core 1"], TRAIN_INTERVAL)

    make_task("11:33", ["Begin. geometry task"], TASK_GEO_INTERVAL)
    ...
    make_task("14:46", ["Start. geometry task."], TASK_GEO_INTERVAL, False)
    ...
    #make_task("16:42", ["Start. Learn English"], READ_INTERVAL)
    ...
    make_task("17:22", ["Start. geometry task "], TASK_GEO_INTERVAL)
    make_task("17:34", TASK_TEXT, TASK_INTERVAL)
    make_task("17:50", TASK_TEXT, TASK_INTERVAL)
    make_task("18:10", ["Start. training shoulders"], 0, False)
    ...
    make_task("19:15", TASK_TEXT, TASK_INTERVAL)
